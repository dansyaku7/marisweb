    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (min-width: 1024px) and (max-width: 1280px) { .left-pane { padding: 40px 40px; } }

        .accent-number {
          position: absolute; right: -20px; top: 50%; transform: translateY(-50%);
          font-size: 320px; font-weight: 800; line-height: 1;
          color: transparent; -webkit-text-stroke: 1px rgba(240,165,0,0.08);
          pointer-events: none; letter-spacing: -20px; user-select: none;
        }
        .orb-1 { position: absolute; top: -80px; left: -80px; width: 420px; height: 420px; background: radial-gradient(circle, rgba(240,165,0,0.1) 0%, transparent 70%); pointer-events: none; }
        .orb-2 { position: absolute; bottom: -100px; right: -60px; width: 380px; height: 380px; background: radial-gradient(circle, rgba(240,165,0,0.07) 0%, transparent 70%); pointer-events: none; }

        .tag-pill { display: inline-flex; align-items: center; gap: 6px; background: rgba(240,165,0,0.1); border: 1px solid rgba(240,165,0,0.25); border-radius: 999px; padding: 5px 14px; font-size: 11px; font-weight: 700; color: #C87A00; letter-spacing: 0.08em; text-transform: uppercase; margin-bottom: 24px; }
        ...
        */
        ...
        @media (min-width: 480px)  { .right-pane { padding: 48px 32px; } }
        @media (min-width: 1024px) { .right-pane { width: 50%; padding: 60px 72px; flex-shrink: 0; } }
        ...
        .pw-toggle { position: absolute; right: 0; top: 0; bottom: 0; width: 48px; display: flex; align-items: center; justify-content: center; background: none; border: none; cursor: pointer; color: #B8B0A0; transition: color 0.2s; border-radius: 0 12px 12px 0; flex-shrink: 0; line-height: 0; }
        ...
        <div className="left-pane">
          ...
          <div style={{ position: "relative", zIndex: 10 }}>
            <div className="desktop-logo">
              <img src="/images/marusindologo.png" alt="PT Marusindo"
                style={{ height: "56px", width: "auto", objectFit: "contain", display: "block" }} />
            </div>
            <div className="tag-pill">
              <span className="tag-pill-dot" /> Enterprise Asset Platform
            </div>
            <h1 className="left-heading">
              Monitoring Aset &<br /><span>Inspeksi Berkala</span>
            </h1>
          ...
          <div className="form-wrap">
            ...
            <form onSubmit={handleSubmit}>
              <div className="field">
                ...
                <input id="email" className="field-input" type="email" required
              ...
              <div className="field">
                ...
                <div className="input-wrap">
                  <input id="password" className="field-input field-input--pw"
